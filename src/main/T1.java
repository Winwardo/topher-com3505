...
class Scene {
    ...
    public void render(GL2 gl) {
        ...
        cubeNode.attachRenderable(new Cube(glut, 0.5f));
        ...
        sceneGraph.attachRenderable(cubeSpin);
        sceneGraph.attachRenderable(new Cube(glut, 1.0f));
        sceneGraph.setRotation(new Vector3(0, 0, 1), (float) rotate);
